            ...
            <div class="content content-top shadow">
                ...
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="judul" placeholder="Masukan Judul Laporan" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <textarea name="lokasi" placeholder="Lokasi Kejadian" class="form-control"></textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #112D4E" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 Yoga Esabio • All rights reserved</p>
    </div>
</div>
@endsection
